...
public final class ProgressView extends View {
    ...
    public ProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBarWidth =
            (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, mBarWidth, getResources().getDisplayMetrics());
        mRimWidth =
            (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, mRimWidth, getResources().getDisplayMetrics());
        mCircleRadius = (int) TypedValue
            .applyDimension(TypedValue.COMPLEX_UNIT_DIP, mCircleRadius, getResources().getDisplayMetrics());
        ...
        float animationValue =
            Settings.Global.getFloat(getContext().getContentResolver(), Settings.Global.ANIMATOR_DURATION_SCALE, 1);

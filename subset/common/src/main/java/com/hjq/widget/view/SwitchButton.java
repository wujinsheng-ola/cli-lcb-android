...
public final class SwitchButton extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        switch (MeasureSpec.getMode(widthMeasureSpec)) {
            ...
            case MeasureSpec.UNSPECIFIED:
                widthMeasureSpec = MeasureSpec.makeMeasureSpec((int) (
                    TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 56, getResources().getDisplayMetrics())
        ...
        switch (MeasureSpec.getMode(heightMeasureSpec)) {
            ...
            case MeasureSpec.UNSPECIFIED:
                heightMeasureSpec =
                    MeasureSpec.makeMeasureSpec((int) (MeasureSpec.getSize(widthMeasureSpec) * mAspectRatio)

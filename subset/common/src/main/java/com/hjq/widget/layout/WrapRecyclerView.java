...
public final class WrapRecyclerView extends RecyclerView {
    ...
    private static final class WrapRecyclerAdapter extends Adapter<ViewHolder> {
         ...
         */
        private static void adjustSpanSize(RecyclerView recyclerView, final WrapRecyclerAdapter wrapAdapter,
                                           final Adapter realAdapter) {
            ...
            switch (viewType) {
                ...
                case FOOTER_VIEW_TYPE:
                    return newWrapViewHolder(mFooterViews.get(getPosition() - getHeaderViewsCount() -
                        (mRealAdapter != null ? mRealAdapter.getItemCount() : 0)));
                default:
        ...
        public long getItemId(int position) {
            if (mRealAdapter != null && position > getHeaderViewsCount() - 1 &&
                position < getHeaderViewsCount() + mRealAdapter.getItemCount()) {

...
public class BottomBarItem extends LinearLayout {
    ...
    public void setNormalIcon(int resId) {
        setNormalIcon(getDrawable(context, resId));
    }
    ...
    public void setSelectedIcon(int resId) {
        setSelectedIcon(getDrawable(context, resId));
    }
    ...
    public static final class Builder {
        ...
        public Builder(Context context) {
            this.context = context;
            titleTextSize = sp2px(context, 12);
            titleNormalColor = 0x999999;
        ...
        public Builder titleTextSize(int titleTextSize) {
            this.titleTextSize = sp2px(context, titleTextSize);
            return this;
        }
        ...
        public Builder unreadTextSize(int unreadTextSize) {
            this.unreadTextSize = sp2px(context, unreadTextSize);
            return this;
        }
        ...
        public Builder msgTextSize(int msgTextSize) {
            this.msgTextSize = sp2px(context, msgTextSize);
            return this;
        }
        ...
        public BottomBarItem create(int normalIconId, int selectedIconId, String text) {
            return create(getDrawable(context, normalIconId), getDrawable(context, selectedIconId), text);
        }

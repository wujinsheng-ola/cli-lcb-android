...
public class TRefreshFooter extends LinearLayout implements RefreshFooter {
    ...
    public TRefreshFooter(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
